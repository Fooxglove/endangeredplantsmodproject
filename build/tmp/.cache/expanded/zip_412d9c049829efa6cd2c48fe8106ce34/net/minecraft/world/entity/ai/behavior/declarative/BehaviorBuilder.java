...
public class BehaviorBuilder<E extends LivingEntity, M> implements App<BehaviorBuilder.Mu<E>, M> {
   ...
   public static <E extends LivingEntity> OneShot<E> create(Function<BehaviorBuilder.Instance<E>, ? extends App<BehaviorBuilder.Mu<E>, Trigger<E>>> pInitializer) {
      final BehaviorBuilder.TriggerWithResult<E, Trigger<E>> triggerwithresult = get(pInitializer.apply(instance()));
   ...
   public static <E extends LivingEntity> OneShot<E> sequence(Trigger<? super E> pPredicateTrigger, Trigger<? super E> pTrigger) {
      return create((p_259495_) -> {
         return p_259495_.group(p_259495_.ifTriggered(pPredicateTrigger)).apply(p_259495_, (p_260322_) -> {
            return pTrigger::trigger;
         });
      });
   }
   ...
   public static <E extends LivingEntity> OneShot<E> triggerIf(Predicate<E> pPredicate) {
      return create((p_260353_) -> {
         return p_260353_.point((p_259280_, p_259428_, p_259845_) -> {
            return pPredicate.test(p_259428_);
         });
      });
   }
   ...
   public static <E extends LivingEntity> OneShot<E> triggerIf(BiPredicate<ServerLevel, E> pPredicate) {
      return create((p_260191_) -> {
         return p_260191_.point((p_259079_, p_259093_, p_260140_) -> {
            return pPredicate.test(p_259079_, p_259093_);
         });
      });
   }
