...
public class StrollAroundPoi {
   ...
   public static OneShot<PathfinderMob> create(MemoryModuleType<GlobalPos> pPoiPosMemory, float pSpeedModifier, int pMaxDistFromPoi) {
      ...
      return BehaviorBuilder.create((p_258827_) -> {
         return p_258827_.group(p_258827_.registered(MemoryModuleType.WALK_TARGET), p_258827_.present(pPoiPosMemory)).apply(p_258827_, (p_258821_, p_258822_) -> {
               ...
               if (p_258834_.dimension() == globalpos.dimension() && globalpos.pos().closerToCenterThan(p_258835_.position(), (double)pMaxDistFromPoi)) {
                  if (p_258836_ <= mutablelong.getValue()) {
                     ...
                     p_258821_.setOrErase(optional.map((p_258816_) -> {
                        return new WalkTarget(p_258816_, pSpeedModifier, 1);
                     }));
