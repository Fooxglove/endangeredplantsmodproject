...
public final class LevelSettings {
   ...
   public LevelSettings withDataConfiguration(WorldDataConfiguration pDataConfiguration) {
      return new LevelSettings(this.levelName, this.gameType, this.hardcore, this.difficulty, this.allowCommands, this.gameRules, pDataConfiguration, this.lifecycle);
   }
