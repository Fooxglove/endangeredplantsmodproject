...
public interface StructurePieceType {
   ...
   public interface ContextlessType extends StructurePieceType {
      ...
      default StructurePiece load(StructurePieceSerializationContext pContext, CompoundTag pTag) {
         return this.load(pTag);
      }
   }
   ...
   public interface StructureTemplateType extends StructurePieceType {
      ...
      default StructurePiece load(StructurePieceSerializationContext pContext, CompoundTag pTag) {
         return this.load(pContext.structureTemplateManager(), pTag);
      }
   }
}