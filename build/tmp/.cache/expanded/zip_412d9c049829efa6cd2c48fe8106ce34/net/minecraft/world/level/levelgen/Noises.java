...
public class Noises {
   ...
   public static NormalNoise instantiate(HolderGetter<NormalNoise.NoiseParameters> pNoises, PositionalRandomFactory pRandom, ResourceKey<NormalNoise.NoiseParameters> pResourceKey) {
