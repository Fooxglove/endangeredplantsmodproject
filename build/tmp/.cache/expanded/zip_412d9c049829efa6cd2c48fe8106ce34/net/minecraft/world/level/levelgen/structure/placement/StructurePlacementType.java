...
public interface StructurePlacementType<SP extends StructurePlacement> {
   ...
   private static <SP extends StructurePlacement> StructurePlacementType<SP> register(String pName, Codec<SP> pCodec) {
      return Registry.register(BuiltInRegistries.STRUCTURE_PLACEMENT, pName, () -> {
         return pCodec;
      });
   }
}