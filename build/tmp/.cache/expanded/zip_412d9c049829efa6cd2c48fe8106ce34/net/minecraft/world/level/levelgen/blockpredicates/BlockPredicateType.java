...
public interface BlockPredicateType<P extends BlockPredicate> {
   ...
   private static <P extends BlockPredicate> BlockPredicateType<P> register(String pName, Codec<P> pCodec) {
      return Registry.register(BuiltInRegistries.BLOCK_PREDICATE_TYPE, pName, () -> {
         return pCodec;
      });
   }
}