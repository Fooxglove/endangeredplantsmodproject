...
public class AnvilMenu extends ItemCombinerMenu {
   ...
   protected void onTake(Player pPlayer, ItemStack pStack) {
      ...
      float breakChance = net.minecraftforge.common.ForgeHooks.onAnvilRepair(pPlayer, pStack, AnvilMenu.this.inputSlots.getItem(0), AnvilMenu.this.inputSlots.getItem(1));
