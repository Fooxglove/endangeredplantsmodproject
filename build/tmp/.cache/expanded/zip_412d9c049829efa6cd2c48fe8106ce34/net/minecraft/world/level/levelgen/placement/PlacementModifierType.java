...
public interface PlacementModifierType<P extends PlacementModifier> {
   ...
   private static <P extends PlacementModifier> PlacementModifierType<P> register(String pName, Codec<P> pCodec) {
      return Registry.register(BuiltInRegistries.PLACEMENT_MODIFIER_TYPE, pName, () -> {
         return pCodec;
      });
   }
}