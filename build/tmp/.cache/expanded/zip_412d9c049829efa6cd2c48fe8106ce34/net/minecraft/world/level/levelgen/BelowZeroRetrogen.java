...
public final class BelowZeroRetrogen {
   ...
   public static BelowZeroRetrogen read(CompoundTag pTag) {
      ...
      return chunkstatus == ChunkStatus.EMPTY ? null : new BelowZeroRetrogen(chunkstatus, Optional.of(BitSet.valueOf(pTag.getLongArray("missing_bedrock"))));
   }
         ...
         for(int l = 0; l < 16; ++l) {
            if (this.hasBedrockHole(k, l)) {
               BlockPos.betweenClosed(k, i, l, k, j, l).forEach((p_198219_) -> {
                  pChunk.setBlockState(p_198219_, Blocks.AIR.defaultBlockState(), false);
               });
            }
         }
      }
