...
public class GravityProcessor extends StructureProcessor {
   ...
   public StructureTemplate.StructureBlockInfo processBlock(LevelReader pLevel, BlockPos pOffset, BlockPos pPos, StructureTemplate.StructureBlockInfo pBlockInfo, StructureTemplate.StructureBlockInfo pRelativeBlockInfo, StructurePlaceSettings pSettings) {
      ...
      int i = pLevel.getHeight(heightmap$types, blockpos.getX(), blockpos.getZ()) + this.offset;
      int j = pBlockInfo.pos().getY();
      return new StructureTemplate.StructureBlockInfo(new BlockPos(blockpos.getX(), i + j, blockpos.getZ()), pRelativeBlockInfo.state(), pRelativeBlockInfo.nbt());
   }
