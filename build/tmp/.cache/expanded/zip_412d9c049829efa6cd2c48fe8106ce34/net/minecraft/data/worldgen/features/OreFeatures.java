...
public class OreFeatures {
   ...
   public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> pContext) {
      ...
      FeatureUtils.register(pContext, ORE_REDSTONE, Feature.ORE, new OreConfiguration(List.of(OreConfiguration.target(ruletest1, Blocks.REDSTONE_ORE.defaultBlockState()), OreConfiguration.target(ruletest2, Blocks.DEEPSLATE_REDSTONE_ORE.defaultBlockState())), 8));
      ...
      FeatureUtils.register(pContext, ORE_INFESTED, Feature.ORE, new OreConfiguration(List.of(OreConfiguration.target(ruletest1, Blocks.INFESTED_STONE.defaultBlockState()), OreConfiguration.target(ruletest2, Blocks.INFESTED_DEEPSLATE.defaultBlockState())), 9));
      FeatureUtils.register(pContext, ORE_EMERALD, Feature.ORE, new OreConfiguration(List.of(OreConfiguration.target(ruletest1, Blocks.EMERALD_ORE.defaultBlockState()), OreConfiguration.target(ruletest2, Blocks.DEEPSLATE_EMERALD_ORE.defaultBlockState())), 3));
