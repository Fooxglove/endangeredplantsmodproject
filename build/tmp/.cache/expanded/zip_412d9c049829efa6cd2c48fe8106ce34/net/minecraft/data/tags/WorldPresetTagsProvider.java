...
public class WorldPresetTagsProvider extends TagsProvider<WorldPreset> {
   ...
   public WorldPresetTagsProvider(PackOutput pOutput, CompletableFuture<HolderLookup.Provider> pProvider, String modId, @org.jetbrains.annotations.Nullable net.minecraftforge.common.data.ExistingFileHelper existingFileHelper) {
      super(pOutput, Registries.WORLD_PRESET, pProvider, modId, existingFileHelper);
   }
