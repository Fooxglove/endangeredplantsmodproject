...
public interface EntitySubPredicate {
   ...
   static EntitySubPredicate fromJson(@Nullable JsonElement pJson) {
      if (pJson != null && !pJson.isJsonNull()) {
         JsonObject jsonobject = GsonHelper.convertToJsonObject(pJson, "type_specific");
   ...
   public interface Type {
      EntitySubPredicate deserialize(JsonObject pJson);
   }
