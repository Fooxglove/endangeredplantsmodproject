...
public class ItemColors {
   ...
   public int getColor(ItemStack pStack, int pTintIndex) {
      ItemColor itemcolor = this.itemColors.get(net.minecraftforge.registries.ForgeRegistries.ITEMS.getDelegateOrThrow(pStack.getItem()));
   ...
   public void register(ItemColor pItemColor, ItemLike... pItems) {
      for(ItemLike itemlike : pItems) {
         this.itemColors.put(net.minecraftforge.registries.ForgeRegistries.ITEMS.getDelegateOrThrow(itemlike.asItem()), pItemColor);
      }
