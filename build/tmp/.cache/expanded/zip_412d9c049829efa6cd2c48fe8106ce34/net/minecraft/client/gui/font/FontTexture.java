...
public class FontTexture extends AbstractTexture implements Dumpable {
   ...
   public void dumpContents(ResourceLocation pResourceLocation, Path pPath) {
      ...
      TextureUtil.writeAsPNG(pPath, s, this.getId(), 0, 256, 256, (p_285145_) -> {
