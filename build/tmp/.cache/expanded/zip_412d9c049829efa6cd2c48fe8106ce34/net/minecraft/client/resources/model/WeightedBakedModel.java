...
public class WeightedBakedModel implements net.minecraftforge.client.model.IDynamicBakedModel {
   ...
   public List<BakedQuad> getQuads(@Nullable BlockState pState, @Nullable Direction pDirection, RandomSource pRandom, net.minecraftforge.client.model.data.ModelData modelData, @org.jetbrains.annotations.Nullable net.minecraft.client.renderer.RenderType renderType) {
      return WeightedRandom.getWeightedItem(this.list, Math.abs((int)pRandom.nextLong()) % this.totalWeight).map((p_235065_) -> {
         return p_235065_.getData().getQuads(pState, pDirection, pRandom, modelData, renderType);
