...
public record TelemetryProperty<T>(String id, String exportKey, Codec<T> codec, TelemetryProperty.Exporter<T> exporter) {
   ...
   public static TelemetryProperty<GameLoadTimesEvent.Measurement> gameLoadMeasurement(String pId, String pExportKey) {
      return create(pId, pExportKey, GameLoadTimesEvent.Measurement.CODEC, (p_286179_, p_286180_, p_286181_) -> {
   ...
   public interface Exporter<T> {
      void apply(TelemetryPropertyContainer pContainer, String p_261962_, T p_262012_);
   }
