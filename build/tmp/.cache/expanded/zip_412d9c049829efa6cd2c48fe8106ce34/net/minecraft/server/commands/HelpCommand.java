...
public class HelpCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> pDispatcher) {
      pDispatcher.register(Commands.literal("help").executes((p_288460_) -> {
         ...
         ParseResults<CommandSourceStack> parseresults = pDispatcher.parse(StringArgumentType.getString(p_288458_, "command"), p_288458_.getSource());
         if (parseresults.getContext().getNodes().isEmpty()) {
            throw ERROR_FAILED.create();
         } else {
            Map<CommandNode<CommandSourceStack>, String> map = pDispatcher.getSmartUsage(Iterables.getLast(parseresults.getContext().getNodes()).getNode(), p_288458_.getSource());
