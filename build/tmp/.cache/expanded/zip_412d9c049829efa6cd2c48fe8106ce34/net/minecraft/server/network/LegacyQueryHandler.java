...
public class LegacyQueryHandler extends ChannelInboundHandlerAdapter {
   ...
   public LegacyQueryHandler(ServerConnectionListener pServerConnectionListener) {
      this.serverConnectionListener = pServerConnectionListener;
   }
         ...
         if (bytebuf.readUnsignedByte() == 254) {
            ...
            switch (i) {
               case 0:
                  ...
                  this.sendFlushAndClose(pContext, this.createReply(s2));
                  break;
               case 1:
                  ...
                  this.sendFlushAndClose(pContext, this.createReply(s));
                  break;
               default:
   ...
   private void sendFlushAndClose(ChannelHandlerContext pContext, ByteBuf pData) {
      pContext.pipeline().firstContext().writeAndFlush(pData).addListener(ChannelFutureListener.CLOSE);
   }
