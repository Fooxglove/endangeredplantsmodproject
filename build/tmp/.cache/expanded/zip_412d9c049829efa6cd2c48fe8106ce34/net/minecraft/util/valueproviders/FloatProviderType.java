...
public interface FloatProviderType<P extends FloatProvider> {
   ...
   static <P extends FloatProvider> FloatProviderType<P> register(String pName, Codec<P> pCodec) {
      return Registry.register(BuiltInRegistries.FLOAT_PROVIDER_TYPE, pName, () -> {
         return pCodec;
      });
   }
}