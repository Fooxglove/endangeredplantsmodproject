...
public class StatsCounterFix extends DataFix {
   ...
   @Nullable
   protected String upgradeItem(String pItem) {
      return ItemStackTheFlatteningFix.updateItem(pItem, 0);
   }

   protected String upgradeBlock(String pBlock) {
      return BlockStateData.upgradeBlock(pBlock);
   }
}