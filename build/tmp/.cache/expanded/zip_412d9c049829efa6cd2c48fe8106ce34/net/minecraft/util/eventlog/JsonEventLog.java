...
public class JsonEventLog<T> implements Closeable {
   ...
   public void write(T pData) throws IOException, JsonIOException {
      JsonElement jsonelement = Util.getOrThrow(this.codec.encodeStart(JsonOps.INSTANCE, pData), IOException::new);
