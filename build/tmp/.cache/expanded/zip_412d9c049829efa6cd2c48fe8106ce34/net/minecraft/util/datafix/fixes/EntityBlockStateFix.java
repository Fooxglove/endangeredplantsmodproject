...
public class EntityBlockStateFix extends DataFix {
   ...
   private Typed<?> updateBlockToBlockState(Typed<?> pTyped, String pTileKey, String pDataKey, String pOutputKey) {
      Type<Pair<String, Either<Integer, String>>> type = DSL.field(pTileKey, DSL.named(References.BLOCK_NAME.typeName(), DSL.or(DSL.intType(), NamespacedSchema.namespacedString())));
