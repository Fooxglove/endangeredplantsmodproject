...
public class CommonLinks {
   ...
   public static String extendRealms(String pSubscriptionId, String pProfieId, boolean pIsTrial) {
      return extendRealms(pSubscriptionId, pProfieId) + "&ref=" + (pIsTrial ? "expiredTrial" : "expiredRealm");
   }

   public static String extendRealms(String pSubscriptionId, String pProfileId) {
      return "https://aka.ms/ExtendJavaRealms?subscriptionId=" + pSubscriptionId + "&profileId=" + pProfileId;
   }
}