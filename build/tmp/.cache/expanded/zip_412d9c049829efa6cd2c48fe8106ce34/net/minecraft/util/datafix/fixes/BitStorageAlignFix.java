...
public class BitStorageAlignFix extends DataFix {
   ...
   private Typed<?> updateHeightmaps(Typed<?> pTyped) {
      return pTyped.update(DSL.remainderFinder(), (p_14765_) -> {
   ...
   private static Dynamic<?> updateBitStorage(Dynamic<?> p_14777_, Dynamic<?> p_14778_, int pNumBits, int pBitWidth) {
