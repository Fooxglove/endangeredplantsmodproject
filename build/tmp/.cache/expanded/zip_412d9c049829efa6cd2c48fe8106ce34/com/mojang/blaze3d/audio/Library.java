...
public class Library {
    ...
    * @param pDeviceSpecifier A string specifying the name of the audio device to use, or null to use the default
    * device.
    * @param pEnableHrtf Whether to enable HRTF (head-related transfer function) for spatial audio.
    */
    ...
    * @param pEnableHrtf Whether to enable HRTF.
    */
    ...
    * @return {@code true} if the default device has changed since the last time this method was called, {@code false}
    * otherwise
    */
    ...
    * @param pDeviceSpecifier The name of the audio device to open, or null to open the default device.
    */
    ...
    * @return an {@linkplain OptionalLong} containing the handle of the opened device if successful, or empty if the
    * device could not be opened
    * @param pDeviceSpecifier A string specifying the name of the audio device to open, or null to use the default
    * device.
    */
    ...
    * @param pChannel The channel to release.
    */
   ...
   /**
    * {@return A list of strings representing the names of available sound devices, or an empty list if no devices are
    * available.}
    */
