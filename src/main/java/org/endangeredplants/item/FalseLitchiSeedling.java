...
public class FalseLitchiSeedling {
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, Endangeredplants.MODID);

    public static final RegistryObject<Item> FALSE_LITCHI_SEEDLING = ITEMS.register("falselitchiseedling",
            () -> new Item(new Item.Properties()) {
                ...
                public InteractionResult useOn(UseOnContext context) {
                    ...
                    if (clickedBlock.is(Blocks.GRASS_BLOCK) ||
                        ...
                        // 如果上方是空气，放置FalseLitchiSeedlingBlock
                        if (context.getLevel().getBlockState(posAbove).isAir()) {
                            context.getLevel().setBlockAndUpdate(posAbove, FalseLitchiSeedlingBlock.FALSE_LITCHI_SEEDLING_BLOCK.get().defaultBlockState());
