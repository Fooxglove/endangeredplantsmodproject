...
import org.endangeredplants.block.HonghePapedaSaplingBlock;

public class HonghePapedaSapling {
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, Endangeredplants.MODID);

    public static final RegistryObject<Item> HONGHE_PAPEDA_SAPLING = ITEMS.register("honghepapedasapling",
            () -> new Item(new Item.Properties()) {
                ...
                public InteractionResult useOn(UseOnContext context) {
                    ...
                    if (clickedBlock.is(Blocks.GRASS_BLOCK) ||
                        ...
                        // 如果上方是空气，放置HonghePapedaSaplingBlock
                        if (context.getLevel().getBlockState(posAbove).isAir()) {
                            context.getLevel().setBlockAndUpdate(posAbove, HonghePapedaSaplingBlock.HONGHE_PAPEDA_SAPLING_BLOCK.get().defaultBlockState());
