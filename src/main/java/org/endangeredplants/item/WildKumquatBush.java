...
public class WildKumquatBush {
    ...
    // 自定义野生金柑灌木物品类
    public static class WildKumquatBushItem extends Item {
        public WildKumquatBushItem(Properties properties) {
            super(properties);
        }
    ...
    // Creates a new item with planting functionality
    public static final RegistryObject<Item> WILD_KUMQUAT_BUSH = ITEMS.register("wildkumquatbush",
            () -> new WildKumquatBushItem(new Item.Properties()));
