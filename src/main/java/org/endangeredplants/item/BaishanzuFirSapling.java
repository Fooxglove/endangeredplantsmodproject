...
import org.endangeredplants.block.BaishanzuFirSaplingBlock;

public class BaishanzuFirSapling {
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, Endangeredplants.MODID);

    public static final RegistryObject<Item> BAISHANZU_FIR_SAPLING = ITEMS.register("baishanzufirsapling",
            () -> new Item(new Item.Properties()) {
                ...
                public InteractionResult useOn(UseOnContext context) {
                    ...
                    if (clickedBlock.is(Blocks.GRASS_BLOCK) ||
                        ...
                        // 如果上方是空气，放置BaishanzuFirSaplingBlock
                        if (context.getLevel().getBlockState(posAbove).isAir()) {
                            context.getLevel().setBlockAndUpdate(posAbove, BaishanzuFirSaplingBlock.BAISHANZU_FIR_SAPLING_BLOCK.get().defaultBlockState());
