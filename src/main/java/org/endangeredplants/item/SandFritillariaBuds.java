...
public class SandFritillariaBuds {
    ...
    // Food properties for Sand Fritillaria Buds (restores 2 health)
    private static final FoodProperties SAND_FRITILLARIA_FOOD = (new FoodProperties.Builder())
            .nutrition(0)  // 0 hunger points
            .saturationMod(0.0f)  // 0 saturation
            .fast()  // Fast to eat
            .effect(() -> new MobEffectInstance(MobEffects.HEAL, 1, 0), 1.0f)  // Instant Health I (restores 2 health)
    ...
    public static final RegistryObject<Item> SAND_FRITILLARIA_BUDS = ITEMS.register("sandfritillariabuds",
            () -> new Item(new Item.Properties().food(SAND_FRITILLARIA_FOOD)) {
                @Override
