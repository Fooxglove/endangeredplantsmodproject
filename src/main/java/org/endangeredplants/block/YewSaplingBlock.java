...
import org.endangeredplants.worldgen.tree.YewGrower;

import java.util.Collections;
import java.util.List;

import static org.endangeredplants.item.YewSapling.YEW_SAPLING;

public class YewSaplingBlock {
    ...
    public static class PlantBlock extends SaplingBlock {
        public PlantBlock(BlockBehaviour.Properties properties) {
            super(new YewGrower(), properties);
        }
    ...
    public static final RegistryObject<Block> YEW_SAPLING_BLOCK = BLOCKS.register("yewsaplingblock",
    ...
    public static final RegistryObject<Item> YEW_SAPLING_ITEM = ITEMS.register("yewsaplingblock",
            () -> new BlockItem(YEW_SAPLING_BLOCK.get(),
                    new Item.Properties()));
