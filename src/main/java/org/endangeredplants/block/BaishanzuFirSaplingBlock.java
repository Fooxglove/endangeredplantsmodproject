...
import org.endangeredplants.worldgen.tree.BaishanzuGrower;

import java.util.Collections;
import java.util.List;

public class BaishanzuFirSaplingBlock {
    ...
    public static class PlantBlock extends SaplingBlock {
        public PlantBlock(BlockBehaviour.Properties properties) {
            super(new BaishanzuGrower(), properties);
        }
        ...
        public List<ItemStack> getDrops(BlockState state, LootParams.Builder builder) {
            ...
            if (tool != null && tool.is(Items.SHEARS)) {
                return Collections.singletonList(new ItemStack(
                        BAISHANZU_FIR_SAPLING_ITEM.get()
                ));
            }
    ...
    public static final RegistryObject<Block> BAISHANZU_FIR_SAPLING_BLOCK = BLOCKS.register("baishanzufirsaplingblock",
    ...
    public static final RegistryObject<Item> BAISHANZU_FIR_SAPLING_ITEM = ITEMS.register("baishanzufirsaplingblock",
            () -> new BlockItem(BAISHANZU_FIR_SAPLING_BLOCK.get(),
                    new Item.Properties()));
